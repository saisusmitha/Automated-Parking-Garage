					...
					<div class="module">
						<?php 
				                  ...
				                  //$temp_date = date("Y-m-d H");
				                   ...
				                   //echo "<h4>Parking Done By The Walkin Users </h4>";
				                  //$current_time = substr($temp_date, 11, 13);

				                   $file = "data/walkin_users.txt";
				                    $file3 = "data/price_plan.txt";
                                      ...
                                      //if($current_date == $json_a[$i]['arrival_date']){
                                        ...
                                        $tally +=$json_a[$i]['duration']*$guest_price;
                                       
                                        
                                      //}
                                      }

                                       echo "<h4>Parking Done By The Walkin Users &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;               Total Revenue:".$tally." </h4>";
                                   ...
                                   $json_a = json_decode($data,true);
                                      ...
                                      //if($current_date == $json_a[$i]['arrival_date']){
                                        ...
                                        echo "<span>Start Time(hours): <b>".$json_a[$i]['start_time']."hr</b></span><br/>";
                                        echo "<span>Duration(hours): <b>".$json_a[$i]['duration']."</b></span><br/>";
                                        echo "<span>Vehicle No: <b>".$json_a[$i]['vehicle_id']."</b></span><br/>";
                                        echo "<span>Tally: <b>".$json_a[$i]['duration']*$guest_price."</b></span><br/>";
                                        echo "<span>Mobile No: <b>".$json_a[$i]['mobile_no']."</b></span><br/>";
                                        echo "<span>Parked Date: <b>".$json_a[$i]['arrival_date']."</b></span><br/>";
                                        echo "<span><strong>Manager Name: </strong><b>".$json_a[$i]['manager_name']."</b></span><br/><br/>";
                                        echo "<hr/>";
