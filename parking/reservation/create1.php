             ...
             if( $json_a[0]["current_date"] < $current_date || $json_a1[0]["current_date"] < $current_date || $json_a2[0]["current_date"] < $current_date ){
                if($json_a[0]["current_date"] < $current_date){
                          ...
                          if(file_put_contents($file, $jsondata)){ echo 'Data successfully saved';//header("location:../base.html");
                            ...
                            echo 'Sorry Data Not saved successfully in "data/day_1.txt"';
                          }
                }
                          ...
                          if(file_put_contents($file1, $jsondata)){ echo 'Data successfully saved';//header("location:../base.html");
                            ...
                            echo 'Sorry Data Not saved successfully in "data/day_2.txt"';
                          }
                }
                          ...
                          if(file_put_contents($file2, $jsondata)){ echo 'Data successfully saved';//header("location:../base.html");
                          }
                          else {
                            echo 'Sorry Data Not saved successfully in "data/day_3.txt"';
                          }
         ...
         // echo $current_time." HIIIIII ".$start_time;
          ...
          if($current_time < $start_time){
                    ...
                    if($ar_date == $current_date){
                      ...
                      if($start_time + $duration <= 24){
                       // echo "26666666666666666666";
                              ...
                              ?>
                                  <script type="text/javascript"> 
                                 location="create.php";                                                                                  
                                  alert("Sorry please enter the valid date");                                                   
                                  //header('location:../base.php');
                                  </script>
                                  <?php
                            }
                      ...
                      //echo "hii11111";
                      //header('location:create.php');  //popup
                      ?>
                    <script type="text/javascript"> 
                    location="create.php";                                                                                  
                    alert("Sorry You Have Selected Date");                                                   
                    //header('location:../base.php');
                    </script>
                    <?php
                    }
           ...
           //echo "hii2222222222";
            ...
            ?>
                    <script type="text/javascript"> 
                    location="create.php";                                                                                  
                    alert("Sorry You Have Entered Invalid Time");                                                   
                    //header('location:../base.php');
                    </script>
                    <?php
          }
    }else if($ar_date == $dateplus1 || $ar_date == $dateplus2){  //429
                    if($ar_date == $current_date){
                                      $data = file_get_contents($file);
                                       $json_a = json_decode($data,true);
                                      //echo $data;
                      ...
                      //echo "244444444444444".$start_time."===============".$duration."+++++++<br/>";
                      if($start_time + $duration <= 24){
                        //echo "244444444444444";
                                      $data = file_get_contents($file);
                                       $json_a = json_decode($data,true);
                                      //echo $data;
                                      for ($i = 0, $len = count($json_a); $i < $len;$i++) {
