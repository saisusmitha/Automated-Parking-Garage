						...
						<form action="php/proceed.php" method="post" class="tabular">
							<div class="form-row">
                                    <label for="">CARD NUMBER</label>
                                        ...
                                        <input type="text" name="cardNumber" placeholder="Valid Card Number" autocomplete="ccnumber" required autofocus 
                                        />
                            ...
                            <div class="form-row">
                                    ...
                                    <input type="text" name="cardExpiry" placeholder="MM / YY" autocomplete="cc-exp" 
                                        required />
                            </div>
